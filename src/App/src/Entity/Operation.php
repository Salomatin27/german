 ...
 * Operation
 *
 * @ORM\Table(name="operation", indexes={@ORM\Index(name="operation_surgeon_surgeon_id_fk", columns={"surgeon_id"}), @ORM\Index(name="operation_patient_patient_id_fk", columns={"patient_id"}), @ORM\Index(name="operation_clinic_clinic_id_fk", columns={"clinic_id"})})
 * @ORM\Entity
 */
class Operation
{
